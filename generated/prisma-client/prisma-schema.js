...
input AvatarCreateInput {
  id: ID
  thumbnailImg: UrlCreateOneInput
  bigImg: UrlCreateOneInput
}
...
input AvatarUpdateDataInput {
  thumbnailImg: UrlUpdateOneInput
  bigImg: UrlUpdateOneInput
}
...
input AvatarWhereInput {
  ...
  id_ends_with: ID
  id_not_ends_with: ID
  thumbnailImg: UrlWhereInput
  bigImg: UrlWhereInput
...
type FileGroupConnection {
  pageInfo: PageInfo!
  edges: [FileGroupEdge]!
  aggregate: AggregateFileGroup!
}

input FileGroupCreateInput {
  id: ID
  name: String!
  fileIndexes: FileIndexCreateManyInput
}
...
input FileGroupSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: FileGroupWhereInput
  AND: [FileGroupSubscriptionWhereInput!]
}

input FileGroupUpdateInput {
  name: String
  fileIndexes: FileIndexUpdateManyInput
}

input FileGroupUpdateManyMutationInput {
  name: String
}
...
input FileGroupWhereInput {
  ...
  fileIndexes_some: FileIndexWhereInput
  AND: [FileGroupWhereInput!]
}

input FileGroupWhereUniqueInput {
  id: ID
  name: String
}
...
input FileIndexCreateInput {
  ...
  mimetype: String!
  size: Int!
  urls: UrlCreateManyWithoutFileIndexInput
}

input FileIndexCreateManyInput {
...
input FileIndexCreateOneWithoutUrlsInput {
  create: FileIndexCreateWithoutUrlsInput
  connect: FileIndexWhereUniqueInput
}

input FileIndexCreateWithoutUrlsInput {
  id: ID
  fileName: String!
  mimetype: String!
  size: Int!
...
input FileIndexScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
...
input FileIndexUpdateDataInput {
  ...
  mimetype: String
  size: Int
  urls: UrlUpdateManyWithoutFileIndexInput
}
...
input FileIndexUpdateManyDataInput {
  fileName: String
  mimetype: String
  size: Int
}

input FileIndexUpdateManyInput {
  create: [FileIndexCreateInput!]
...
input FileIndexUpdateManyWithWhereNestedInput {
...
input FileIndexUpdateOneWithoutUrlsInput {
  create: FileIndexCreateWithoutUrlsInput
  update: FileIndexUpdateWithoutUrlsDataInput
  upsert: FileIndexUpsertWithoutUrlsInput
  delete: Boolean
  disconnect: Boolean
  connect: FileIndexWhereUniqueInput
}

input FileIndexUpdateWithoutUrlsDataInput {
  fileName: String
  mimetype: String
  size: Int
}

input FileIndexUpdateWithWhereUniqueNestedInput {
...
input FileIndexUpsertWithoutUrlsInput {
  update: FileIndexUpdateWithoutUrlsDataInput!
  create: FileIndexCreateWithoutUrlsInput!
}

input FileIndexUpsertWithWhereUniqueNestedInput {
  where: FileIndexWhereUniqueInput!
  update: FileIndexUpdateDataInput!
  create: FileIndexCreateInput!
}
...
input MessageUpdateDataInput {
  ...
  isSend: Int
  type: Int
  talker: WeChatUserUpdateOneWithoutMessageInput
  createTime: DateTime
...
type Mutation {
  ...
  createFileGroup(data: FileGroupCreateInput!): FileGroup!
  updateFileGroup(data: FileGroupUpdateInput!, where: FileGroupWhereUniqueInput!): FileGroup
  updateManyFileGroups(data: FileGroupUpdateManyMutationInput!, where: FileGroupWhereInput): BatchPayload!
  upsertFileGroup(where: FileGroupWhereUniqueInput!, create: FileGroupCreateInput!, update: FileGroupUpdateInput!): FileGroup!
  deleteFileGroup(where: FileGroupWhereUniqueInput!): FileGroup
  deleteManyFileGroups(where: FileGroupWhereInput): BatchPayload!
...
type Query {
  ...
  fileGroup(where: FileGroupWhereUniqueInput!): FileGroup
  fileGroups(where: FileGroupWhereInput, orderBy: FileGroupOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [FileGroup]!
  fileGroupsConnection(where: FileGroupWhereInput, orderBy: FileGroupOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): FileGroupConnection!
...
type Subscription {
  ...
  fileGroup(where: FileGroupSubscriptionWhereInput): FileGroupSubscriptionPayload
...
input UrlCreateInput {
  id: ID
  url: String!
  fileIndex: FileIndexCreateOneWithoutUrlsInput
}

input UrlCreateManyWithoutFileIndexInput {
...
input UrlCreateWithoutFileIndexInput {
  id: ID
  url: String!
}
...
input UrlUpdateDataInput {
  url: String
  fileIndex: FileIndexUpdateOneWithoutUrlsInput
}
...
input UrlUpdateManyWithoutFileIndexInput {
  create: [UrlCreateWithoutFileIndexInput!]
...
input UrlUpdateWithoutFileIndexDataInput {
  url: String
}

input UrlUpdateWithWhereUniqueWithoutFileIndexInput {
...
input UrlUpsertWithWhereUniqueWithoutFileIndexInput {
  where: UrlWhereUniqueInput!
...
input WeChatUserUpdateOneWithoutMessageInput {
  create: WeChatUserCreateWithoutMessageInput
